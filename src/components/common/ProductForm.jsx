...
const ProductForm = ({ handleSubmit, ...props }) => {
  const preferredUnitSystem = utils.getSettingsItem(props.settings, 'default_unit_system');
  const supportedMeasures = ['length', 'mass', 'volume'];
  const unitMeasures = convert()
                          .list()
